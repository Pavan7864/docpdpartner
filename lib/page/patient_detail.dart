                              ...
                              child: Card(
                                ...
                                child: Column(
                                  children: <Widget>[
                                    ...
                                    TextView('Weight',size: 12, weight: FontWeight.w400,colors: Theme.of(context).hintColor,
                                ...
                                child: Column(
                                  children: <Widget>[
                                    ...
                                    TextView(model.vitalData.length==0?'':'${model.vitalData[0].height??''} ',size: 16,weight: FontWeight.w500, colors: Theme.of(context).primaryColor,
                                      mergin: const EdgeInsets.only(top: 10,bottom: 5),),
                                    TextView('Height',size: 12, weight: FontWeight.w400,colors: Theme.of(context).hintColor,
                                      mergin: const EdgeInsets.only(top: 1,bottom: 15),),
                                  ],
                                ),
                              ),
